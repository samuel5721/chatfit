...
import 'package:chatfit/screens/diet_screens/diet_record_screen.dart';
...
import 'package:chatfit/screens/diet_screens/camera_screen.dart';
import 'package:chatfit/screens/chat_bot_screen.dart';
import 'package:chatfit/screens/main_screen.dart';

final routes = {
  '/': (BuildContext context) => const MainScreen(),
  '/dietrecord': (BuildContext context) => const DietRecordScreen(),
  '/dietrecord_camera': (BuildContext context) => const CameraScreen(),
